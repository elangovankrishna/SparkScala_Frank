...
object PopularMoviesDataSets {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("C:/Users/ke20506/Desktop/Projects/spark/Testdata/ml-100k/u.item").getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val lines = spark.sparkContext.textFile("C:/Users/ke20506/Desktop/Projects/spark/Testdata/ml-100k/u.data").map(x => Movie(x.split("\t")(1).toInt))
