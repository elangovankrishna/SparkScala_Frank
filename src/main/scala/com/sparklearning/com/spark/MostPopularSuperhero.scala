...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("C:/Users/ke20506/Desktop/Projects/spark/SparkScala/marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("C:/Users/ke20506/Desktop/Projects/spark/SparkScala/marvel-graph.txt")
